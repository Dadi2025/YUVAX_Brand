        ...
        <div style={{ minHeight: '100vh', paddingTop: '120px', paddingBottom: '4rem' }}>
            <div className="container">
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    <h1 style={{ fontSize: '3rem', marginBottom: '2rem', textAlign: 'center' }}>ABOUT YUVA X</h1>

                    <div style={{ marginBottom: '3rem' }}>
                        <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
                            YUVA X is not just a clothing brand; it's a movement. Born in the digital age, we bridge the gap between streetwear culture and futuristic aesthetics.
                        </p>
